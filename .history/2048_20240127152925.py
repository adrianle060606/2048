...
class Board(object):
                ...
                if tile_value != 0:
                    ...
                    while not finished_moving:
                        ...
                        if not finished_moving:
                            ...
                            self.add_animation(init_pos, final_pos, init_tile_value, abs(tile_value))
    ...
    def add_animation(self, init_pos, final_pos, init_tile_value, final_tile_value):
        self.animations.append((init_pos, final_pos, init_tile_value, final_tile_value))
    ...
    def draw(self, surface):
        ...
        for y in range(len(self.state)):
            for x in range(len(self.state[y])):
                if self.state[y][x] != 0:
                    draw_tile(constants.TILE_WIDTH * x, constants.TILE_WIDTH * y, str(2 ** self.state[y][x]))
                else:
    ...
    def draw_tile(self, x, y, tile_value):
        pygame.draw.rect(surface, (0, 0, 128), pygame.Rect((x, y, constants.TILE_WIDTH - constants.TILE_BORDER, constants.TILE_WIDTH-constants.TILE_BORDER)))
