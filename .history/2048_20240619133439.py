...
class gameManager():
    ...
    def __init__(self):
        ...
        self.__logo = pygame.image.load("Assets/Images/2048_logo.png")
    ...
    def run(self):
        ...
        while not self.__exit:
            ...
            if self.__in_menu:
                ...
                #draw 2048 logo
                imagerect = self.__logo.get_rect()
                self.__screen.blit(self.__logo, (constants.SCREEN_WIDTH/2 - imagerect.width/2,constants.SCREEN_HEIGHT/5 - imagerect.height/2))
                ...
                #draw 2048 logo
                imagerect = self.__logo.get_rect()
                self.__screen.blit(self.__logo, (constants.HEADING_POS[0] - imagerect.width/2, constants.HEADING_POS[1] - imagerect.height/2))
