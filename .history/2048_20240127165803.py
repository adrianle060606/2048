...
class Board(object):
    ...
    def add_animation(self, init_pos, final_pos, init_tile_value, final_tile_value, direction):
        ...
        animation_speed = 4/block_movement
        self.animations.append({"current_pos": init_pos, "final_pos": final_pos, "init_tile_value": init_tile_value, "final_tile_value": final_tile_value, "direction": direction, "animation_speed": })
    ...
    def animate_tiles(self):
        ...
        for animation in self.animations:
            animation_speed = constants.ANIMATION_SPEED
