    ...
    def run(self):
        while not self.exit:
            ...
            if self.in_menu:
                ...
                #draw score menu
                pygame.draw.rect(self.screen, constants.BACKGROUND_GREY, pygame.Rect((400, 50, 100, 70)))
                ...
                #highscore menu
                pygame.draw.rect(self.screen, constants.BACKGROUND_GREY, pygame.Rect((550, 50, 140, 70)))
                font = pygame.font.Font('Assets/Fonts/clear_sans_bold.ttf', 20)
