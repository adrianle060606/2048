...
class gameManager():
    def __init__(self):
        ...
        myimage = pygame.image.load("Assets/Images/arrow-forward.svg")
        ...
        while not self.__exit:
            ...
            if self.__in_menu:
                ...
                if not self.__in_guide:
                    ...
                    #next button
                    self.draw_button(constants.NEXT_BTN, constants.TILE_COLOURS[11], 30, constants.WHITE, "")
                    self.__screen.blit(self.__new_img, pygame.Rect(480, 610,100,100))
