        ...
        while not self.__exit:
            ...
            if self.__in_menu:
                ...
                if not self.__in_guide:
                    ...
                    myimage = pygame.image.load(self.__tutorial_screens[0])
                    tut_img = pygame.transform.scale(myimage, (400,400))
                    self.__screen.blit(tut_img, (constants.SCREEN_WIDTH-400,constants.SCREEN_HEIGHT/2))
