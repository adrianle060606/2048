    ...
    def run(self):
        while not self.exit:
            ...
            if self.in_menu:
                ...
                #draw score menu
                pygame.draw.rect(self.screen, constants.BACKGROUND_GREY, pygame.Rect((400, 50, 100, 60)))
                ...
                textRect = text.get_rect()
                textRect.center = (450, 83)
                self.screen.blit(text, textRect)

                #highscore menu
                pygame.draw.rect(self.screen, constants.BACKGROUND_GREY, pygame.Rect((550, 50, 140, 60)))
                font = pygame.font.Font('Assets/Fonts/clear_sans_bold.ttf', 20)
