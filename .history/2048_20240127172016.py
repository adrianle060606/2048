...
class Board(object):
                ...
                if tile_value != 0:
                    ...
                    while not finished_moving:
                        ...
                        if not finished_moving:
                            ...
                            self.add_animation(init_pos, abs(final_pos), init_tile_value, abs(tile_value), direction)
    ...
    def animate_tiles(self):
        ...
        for animation in animation_removal:
            ...
            self.state[animation["final_pos"][1] // constants.TILE_WIDTH][animation["final_pos"][0] // constants.TILE_WIDTH] -= 100
