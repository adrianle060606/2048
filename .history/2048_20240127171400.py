...
class Board(object):
                ...
                if tile_value != 0:
                    ...
                    while not finished_moving:
                        ...
                        if not finished_moving:
                            ...
                            # first add 100 to the number to let program know that it is in animation
                            self.temp_state[prev_y_target][prev_x_target] += 100
    ...
    def animate_tiles(self):
        ...
        for animation in animation_removal:
            ...
            print(animation["final_pos"][0] // constants.TILE_WIDTH, animation["final_pos"][1] // constants.TILE_WIDTH)
            self.state[animation["final_pos"][0] / constants.TILE_WIDTH][animation["final_pos"][1] / constants.TILE_WIDTH] -= 100
    ...
    def draw(self, surface):
        ...
        for y in range(len(self.state)):
            for x in range(len(self.state[y])):
                if self.state[y][x] != 0 and self.state[y][x] <= 100:
