...
class Board(object):
    ...
    def add_animation(self, init_pos, final_pos, init_tile_value, final_tile_value, direction):
        self.animations.append({"current_pos": init_pos, "init_pos": init_pos "final_pos": final_pos, "init_tile_value": init_tile_value, "final_tile_value": final_tile_value, "direction": direction})
